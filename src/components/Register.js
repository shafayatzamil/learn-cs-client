   ...
   return (
      <div className='flex flex-col gap-16 px-4 py-8 max-w-lg mx-auto'>
         <form className='flex flex-col gap-5' onSubmit={handleSubmit}>
            ...
            <button className='self-start px-6 py-3 text-lg bg-primary text-white rounded'>Sign up</button>
            {signupError && <span className='text-red-600/75'>{signupError}</span>}
            {/* <p className='text-red-600/75'>{loginError}</p> */}
         </form>
         ...
         <div className='flex items-center flex-wrap gap-4'>
            ...
            <div className='flex gap-5'>
               ...
               <button aria-label='Log in with Twitter' className='border-br-1 border-primary p-3 rounded-sm'>
                  <svg
                     xmlns='http://www.w3.org/2000/svg'
                     viewBox='0 0 32 32'
                     className='h-6 w-6 fill-current'
               ...
               <button onClick={handleWithGithub} aria-label='Log in with GitHub' className='border-br-1 border-primary p-3 rounded-sm'>
                  <svg
                     xmlns='http://www.w3.org/2000/svg'
                     viewBox='0 0 32 32'
                     className='h-6 w-6 fill-current'
         ...
         <span>Already have an account? <Link to='/login' className='text-primary font-semibold underline'>login</Link></span>
      </div>
   )
}
